            ...
            <Row gutter={16} className='d-flex align-items-center' >
                ...
                <Col lg={8} className='text-left p-5'>
                    <Form layout='vertical' className='login-form p-5'>
                         ...
                         <button className="btn1 my-0 mx-auto w-full text-md text-white hover:bg-gray-50 hover:text-black rounded-lg px-4 py-3 focus:outline-none">Đăng Nhập</button>                         
