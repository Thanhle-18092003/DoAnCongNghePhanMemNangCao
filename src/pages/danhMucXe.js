...
const danhMucXe = () => {
  return (
    <>
    <div id="dsthuexe">
        {/* PAGE 1 OF DS THUÊ XE */}
        <div className="pageOneOfDsThueXe">
            {/* <!-- logo --> */}
            <div>
            ...
            <div>
                ...
                <div className="flex flex-col my-3 mx-auto w-5/6 shadow-lg overflow-hidden">
                    <table className="shadow-md text-center text-lg font-bold bg-gray-300 rounded-3xl">
                        <tbody>
                            <tr className="dark:border-neutral-500">
                                <td className="px-6 py-4">TOYOTA</td>
                                <td className="px-6 py-4">HONDA</td>
                                <td className="px-6 py-4">FORD</td>
                            </tr>
                            <tr className="dark:border-neutral-500">
                                <td className="px-6 py-4">MECERDES</td>
                                <td className="px-6 py-4">XE 7 CHỖ</td>
                                <td className="px-6 py-4">XE 4 CHỖ</td>
                            </tr>
                            <tr className="dark:border-neutral-500">
                                <td className="px-6 py-4">KIA</td>
                                <td className="px-6 py-4">BWM</td>
                                <td className="px-6 py-4">HUYNDAI</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        {/* <!-- PAGE 2 OF DS THUÊ XE --> */}
        <div className="pageHaiOfDsThueXe">
            <div className="grid grid-cols-4 gap-4">
                ...
                <div>
                    <div
                        className="relative m-5 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
                        <a className="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="#">
                            <img className="object-cover" src={require("../assets/images/xe4.png")} alt="product image" />
                            <span
                                className="absolute top-0 left-0 m-2 rounded-full bg-black px-2 text-center text-sm font-medium text-white">
                                40% OFF</span>
                        </a>
        ...
        {/* <!-- PAGE 3 OF DS THUÊ XE --> */}
        <div
            className="my-10 mx-auto relative flex w-full max-w-[48rem] flex-row rounded-xl bg-red-100 bg-clip-border text-gray-700 shadow-md">
            <div
                className="relative m-0 w-2/5 shrink-0 overflow-hidden rounded-xl rounded-r-none bg-white bg-clip-border text-gray-700">
                <img src={require("../assets/images/imageOfPage5.png")} alt="image" className="h-full w-full object-cover" />
            </div>
            <div className="p-6">
                <h6
